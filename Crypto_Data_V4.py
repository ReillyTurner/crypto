...
def show_info_popup():
    messagebox.showinfo("Project Info", "This application allows you to filter through recent crypto transactions.\n\n"
                                        "You can sort the data, choose how many results to display (1-11), "
...
def setup_gui():
    ...
    # Info icon (top right)
    info_button = tk.Button(window, text="ℹ️", font=("Arial", 12), command=show_info_popup, bd=0, relief="flat")
